...
def _create_mut_seq_class(size: int, fallback: bool) -> type:
    ...
    fallback_project = lambda c: c if fallback else project
    return OptimizedSequence(f"Size{size}{fallback_slug}MutableSequence", (MutableSequence,), {}, internal_size=size, mutable=True, project=fallback_project)
...
_by_size.extend([Size0MutableSequence, Size1MutableSequence, Size2MutableSequence, Size3MutableSequence])
_fallback_by_size.extend([Size0FallbackMutableSequence, Size1FallbackMutableSequence, Size2FallbackMutableSequence, Size3FallbackMutableSequence])